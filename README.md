...
K-AI Contents Award Track B 솔루션 부문 제출을 목표로 하는 AI 소비 캘린더 웹앱 기획 패키지입니다.
...
- 캘린더: 날짜별 지출, 과소비일, 무지출일, 구독 결제일, 선택일 상세 표시
- 추가: 직접 입력, CSV 업로드 미리보기, 교체/병합 반영
- 목표: 월 수입, 목표 소비액, 목표 저축액, 구독 상한, 집중 카테고리 설정
- 코치: AI 결과 표시 계약에 맞춘 오늘의 조정, 미션, 구독 점검, 카테고리 코멘트
...
4. 월간 소비 캘린더에서 과소비일, 무지출일, 구독 결제일을 확인합니다.
