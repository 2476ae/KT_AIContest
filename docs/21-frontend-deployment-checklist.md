...
- 2026-07-15 기준 `npm run verify`는 Vitest 13개 파일, 68개 테스트와 production build를 포함한다.
- 브라우저 smoke flow는 `npm run test:e2e` 24개 시나리오로 샘플 로드, 목표 수정, 직접 입력, 캘린더 반영, AI 코치 진입, 금융 인증정보 미수집 안내를 확인한다.
