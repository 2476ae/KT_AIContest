...
- 프론트는 `VITE_AI_PROVIDER=openai-proxy`, `VITE_AI_PROXY_BASE_URL` 설정 시 OpenAI 프록시 provider를 사용한다.
...
- `npm run verify`: Vitest 8개 파일, 29개 테스트와 Vite production build 통과
