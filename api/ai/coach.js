...
const systemPrompt = [
  ...
  "월 목표 소비액을 초과했더라도 월 수입이 남아 있다면 곧바로 dailyBudget을 0으로 두지 말고, 현실 조정 목표와 조정 후 예상 저축, 남은 일수 기준 하루 한도를 제안한다.",
  ...
  "categoryPlans에는 지출 비중이 큰 분야를 최대 3개 넣고, 각 분야의 현재 지출액, 이번 달 조정 후 목표액, 예상 절약액, 짧은 이유, 짧은 실행 행동을 제시한다.",
